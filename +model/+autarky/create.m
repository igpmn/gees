...
function [ma, ta] = create()
    ...
    for h = homotopy
        ...
        ma = steady(ma ...
            , "fixLevel", fix ...
            , "exogenize", ["nh", "ss_nh_to_ref_nh", "r", "nch_to_netw_minus_nu_0", "upsilon_1_py_to_pu"] ...
            , "endogenize", ["eta0", "ref_nh", "gg_nu", "nu_0", "upsilon_0"] ...
            , "blocks", false ...
        );
    end
