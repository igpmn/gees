% [IrisToolbox] autogenerated preparsed model source code 01-Feb-2024 08:44:13
%
...
!equations(:households)
    ...
    vh * ww = eta0 * (nh/&nh)^eta_short * (ss_nh_to_ref_nh)^eta_long !! vh * ww = eta0 * (ss_nh_to_ref_nh)^eta_long;

    "Auxiliary calibration equation for long-run labor supply"
    ss_nh_to_ref_nh = + rho_nh * ss_nh_to_ref_nh{-1} + (1 - rho_nh) * &ss_nh_to_ref_nh !! ss_nh_to_ref_nh = &nh / ref_nh;
