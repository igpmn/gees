% [IrisToolbox] autogenerated preparsed model source code 22-Sep-2022 08:53:38
%
...
!equations(:open)
    ...
    nfa_to_ngdp * ngdp = + rnfa * nfa_to_ngdp{-1}*ngdp{-1} + bpfeq_to_ngdp * ngdp + bpceq_to_ngdp * ngdp + pxx * xx - fob_pmm * mm + netxq_to_ngdp * ngdp + nfa_to_ngdp_checksum * ngdp;
