% [IrisToolbox] autogenerated preparsed model source code 22-Sep-2022 14:49:58
%
...
!equations
    ...
    0 = + us_nfa_to_ngdp * us_ngdp / us_e + ea_nfa_to_ngdp * ea_ngdp / ea_e + cn_nfa_to_ngdp * cn_ngdp / cn_e + rw_nfa_to_ngdp * rw_ngdp / rw_e ;
        ...
        "Interest parity"
        ea_r = us_r * (ea_exp_e / ea_e * exp(ea_shk_e))^(1/ea_zeta_r) * (&ea_roc_e)^(1-1/ea_zeta_r);
        ...
        "Interest parity"
        cn_r = us_r * (cn_exp_e / cn_e * exp(cn_shk_e))^(1/cn_zeta_r) * (&cn_roc_e)^(1-1/cn_zeta_r);
        ...
        "Interest parity"
        rw_r = us_r * (rw_exp_e / rw_e * exp(rw_shk_e))^(1/rw_zeta_r) * (&rw_roc_e)^(1-1/rw_zeta_r);
