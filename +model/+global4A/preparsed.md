% [IrisToolbox] autogenerated preparsed model source code 18-Apr-2022 22:15:52
%
...
!equations
    ...
    "Monetary policy reaction function"
    log(rw_unc_r) = rw_rho_r * log(rw_unc_r{-1}) + (1-rw_rho_r) * [ + log(&rw_unc_r) + rw_psi_pc * (log(rw_roc_pc{+1}) - log(rw_ss_roc_pc)) + rw_psi_e * (log(rw_roc_e) - log(&rw_roc_e)) ] + rw_shk_r !! rw_pc = rw_pc{-1} * rw_ss_roc_pc;
