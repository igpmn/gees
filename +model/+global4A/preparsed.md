% [IrisToolbox] autogenerated preparsed model source code 05-Sep-2023 17:19:04
%
...
!equations(:production)
    ...
    us_py1 = us_gamma_y2*us_py2 + us_gamma_mq*us_pq !! us_y1 = us_a_y1 * (us_y2/(1-us_gamma_q))^(1-us_gamma_q) * (us_mq/us_gamma_q)^us_gamma_q ;

    us_gamma_y2 * us_y1 = us_y2;

    us_gamma_mq * us_y1 = us_mq;

    us_gamma_y2 = + us_rho_gamma * us_gamma_y2{-1} + (1 - us_rho_gamma) * (1-us_gamma_q)*(&us_py1/&us_py2) !! us_gamma_y2 = (1-us_gamma_q)*(us_py1/us_py2) ;

    us_gamma_mq = + us_rho_gamma * us_gamma_mq{-1} + (1 - us_rho_gamma) * us_gamma_q*(&us_py1/&us_pq) !! us_gamma_mq = us_gamma_q*(us_py1/us_pq) ;
...
!equations(:production)
    ...
    ea_py1 = ea_gamma_y2*ea_py2 + ea_gamma_mq*ea_pq !! ea_y1 = ea_a_y1 * (ea_y2/(1-ea_gamma_q))^(1-ea_gamma_q) * (ea_mq/ea_gamma_q)^ea_gamma_q ;

    ea_gamma_y2 * ea_y1 = ea_y2;

    ea_gamma_mq * ea_y1 = ea_mq;

    ea_gamma_y2 = + ea_rho_gamma * ea_gamma_y2{-1} + (1 - ea_rho_gamma) * (1-ea_gamma_q)*(&ea_py1/&ea_py2) !! ea_gamma_y2 = (1-ea_gamma_q)*(ea_py1/ea_py2) ;

    ea_gamma_mq = + ea_rho_gamma * ea_gamma_mq{-1} + (1 - ea_rho_gamma) * ea_gamma_q*(&ea_py1/&ea_pq) !! ea_gamma_mq = ea_gamma_q*(ea_py1/ea_pq) ;
...
!equations(:production)
    ...
    cn_py1 = cn_gamma_y2*cn_py2 + cn_gamma_mq*cn_pq !! cn_y1 = cn_a_y1 * (cn_y2/(1-cn_gamma_q))^(1-cn_gamma_q) * (cn_mq/cn_gamma_q)^cn_gamma_q ;

    cn_gamma_y2 * cn_y1 = cn_y2;

    cn_gamma_mq * cn_y1 = cn_mq;

    cn_gamma_y2 = + cn_rho_gamma * cn_gamma_y2{-1} + (1 - cn_rho_gamma) * (1-cn_gamma_q)*(&cn_py1/&cn_py2) !! cn_gamma_y2 = (1-cn_gamma_q)*(cn_py1/cn_py2) ;

    cn_gamma_mq = + cn_rho_gamma * cn_gamma_mq{-1} + (1 - cn_rho_gamma) * cn_gamma_q*(&cn_py1/&cn_pq) !! cn_gamma_mq = cn_gamma_q*(cn_py1/cn_pq) ;
...
!equations(:production)
    ...
    rw_py1 = rw_gamma_y2*rw_py2 + rw_gamma_mq*rw_pq !! rw_y1 = rw_a_y1 * (rw_y2/(1-rw_gamma_q))^(1-rw_gamma_q) * (rw_mq/rw_gamma_q)^rw_gamma_q ;

    rw_gamma_y2 * rw_y1 = rw_y2;

    rw_gamma_mq * rw_y1 = rw_mq;

    rw_gamma_y2 = + rw_rho_gamma * rw_gamma_y2{-1} + (1 - rw_rho_gamma) * (1-rw_gamma_q)*(&rw_py1/&rw_py2) !! rw_gamma_y2 = (1-rw_gamma_q)*(rw_py1/rw_py2) ;

    rw_gamma_mq = + rw_rho_gamma * rw_gamma_mq{-1} + (1 - rw_rho_gamma) * rw_gamma_q*(&rw_py1/&rw_pq) !! rw_gamma_mq = rw_gamma_q*(rw_py1/rw_pq) ;
